...
- **비디오 업로드**
  ...
  - [x] MinIO에 비디오 저장
  - [ ] 원본 영상 저화질 코덱 인코딩 (FFmpeg 사용)
    - [ ] 비디오 포맷 변환 (Webm)
    - [ ] 비디오 코덱 변환 (VP9)
    - [ ] 비디오 해상도 변환 (480p, 360p, 240p, 144p)
    - [ ] 비디오 프레임 레이트 변환 (30fps)
    - [ ] 비디오 해상도별 비트레이트 설정:
      - 144p: 50-100 kbps (저해상도 특성 고려)
      - 240p: 80-200 kbps (VCD/초기 웹 비디오 느낌)
      - 360p: 150-400 kbps (2000년대 중반 웹 표준)
      - 480p: 250-600 kbps (초기 디지털 방송/저품질 DVD 느낌)
